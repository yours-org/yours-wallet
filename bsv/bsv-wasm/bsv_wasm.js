...
/**
 */
module.exports.SigHash = Object.freeze({
  FORKID: 64,
  64: 'FORKID',
  ALL: 1,
  1: 'ALL',
  ...
  131: 'Legacy_InputOutput',
});
/**
 */
module.exports.Status = Object.freeze({ Running: 0, 0: 'Running', Finished: 1, 1: 'Finished' });
/**
 */
module.exports.SigningHash = Object.freeze({ Sha256: 0, 0: 'Sha256', Sha256d: 1, 1: 'Sha256d' });
/**
 */
module.exports.AESAlgorithms = Object.freeze({
  AES128_CBC: 0,
  0: 'AES128_CBC',
  AES256_CBC: 1,
  1: 'AES256_CBC',
...
/**
 */
module.exports.PBKDF2Hashes = Object.freeze({ SHA1: 0, 0: 'SHA1', SHA256: 1, 1: 'SHA256', SHA512: 2, 2: 'SHA512' });
/**
 */
class AES {
  __destroy_into_raw() {
...
module.exports.ChainParams = ChainParams;
/**
 */
class CipherKeys {
  static __wrap(ptr) {
...
module.exports.CipherKeys = CipherKeys;
/**
 */
class ECDH {
  __destroy_into_raw() {
...
class ECDSA {
  ...
  static private_key_from_signature_k(signature, public_key, ephemeral_key, preimage, hash_algo) {
    try {
      ...
      const len0 = WASM_VECTOR_LEN;
      wasm.ecdsa_private_key_from_signature_k(
        retptr,
        signature.__wbg_ptr,
        public_key.__wbg_ptr,
        ephemeral_key.__wbg_ptr,
        ptr0,
        len0,
        hash_algo,
      );
...
module.exports.ECIESCiphertext = ECIESCiphertext;
/**
 */
...
module.exports.ExtendedPrivateKey = ExtendedPrivateKey;
/**
 */
...
module.exports.ExtendedPublicKey = ExtendedPublicKey;
/**
 */
class Hash {
  static __wrap(ptr) {
...
module.exports.P2PKHAddress = P2PKHAddress;
/**
 */
class PrivateKey {
  static __wrap(ptr) {
...
module.exports.RecoveryInfo = RecoveryInfo;
/**
 */
class Script {
  static __wrap(ptr) {
...
module.exports.SighashSignature = SighashSignature;
/**
 */
class Signature {
  static __wrap(ptr) {
...
class Transaction {
  ...
  sign(priv_key, sighash, n_tx_in, unsigned_script, value) {
    try {
      ...
      wasm.transaction_sign(
        retptr,
        this.__wbg_ptr,
        priv_key.__wbg_ptr,
        sighash,
        n_tx_in,
        unsigned_script.__wbg_ptr,
        value,
      );
      var r0 = getInt32Memory0()[retptr / 4 + 0];
      var r1 = getInt32Memory0()[retptr / 4 + 1];
...
class TxIn {
  ...
  constructor(prev_tx_id, vout, unlocking_script, sequence) {
    ...
    const ret = wasm.txin_new(
      ptr0,
      len0,
      vout,
      unlocking_script.__wbg_ptr,
      !isLikeNone(sequence),
      isLikeNone(sequence) ? 0 : sequence,
    );
  ...
  get_prev_tx_id_hex(little_endian) {
    ...
    try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      wasm.txin_get_prev_tx_id_hex(
        retptr,
        this.__wbg_ptr,
        isLikeNone(little_endian) ? 0xffffff : little_endian ? 1 : 0,
      );
      var r0 = getInt32Memory0()[retptr / 4 + 0];
      var r1 = getInt32Memory0()[retptr / 4 + 1];
      deferred1_0 = r0;
...
const path = require('path').join(__dirname, 'bsv_wasm_bg.wasm');
